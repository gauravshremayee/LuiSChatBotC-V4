...
{
    public partial class IntentOperations: IRecognizerConvert
    {
        public string Text;
        ...
        public class _Entities
        {
           ...
           // public string[][] SharepointSearch;
            ...
            public class _InstanceFrom
            {
                ...
                public InstanceData[] DocType;
                //public InstanceData[] SharepointSearch;
        ...
        {
            var app = JsonConvert.DeserializeObject<IntentOperations>(JsonConvert.SerializeObject(result, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }));
            Text = app.Text;
